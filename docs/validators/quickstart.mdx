...
import QuickStartZOGUXSnippet from '/snippets/zogux-quickstart.mdx';
...
```bash
curl -sSL https://raw.githubusercontent.com/zoguxprotocol/slinky/main/scripts/install.sh | sudo bash
```

### From GitHub Releases

Head over to our [GitHub Releases](https://github.com/zoguxprotocol/slinky/releases) page and download the binary that matches your machine's architecture.
...
```shell
git clone git@github.com:zoguxprotocol/slinky.git
cd slinky
...
<Tabs>
    ...
    <Tab title="Zogux Blockchain">
        <QuickStartZOGUXSnippet />
    </Tab>
