...
First, add the [x/marketmap](https://github.com/zoguxprotocol/slinky/blob/main/x/marketmap/README.md) and [x/oracle](https://github.com/zoguxprotocol/slinky/tree/main/x/oracle) keepers to the application.
