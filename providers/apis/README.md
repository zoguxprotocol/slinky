...
* [Zogux](./zogux/README.md) - Zogux is a decentralized exchange built using the Cosmos SDK. Zogux is a market map provider - we use it to fetch the list of markets the side-car should fetch prices for.
